...
export const CONTRACTS: Record<number, NetworkConfig> = {
  ...
  11155420: {
    ...
    BASE_REGISTRAR:
      process.env.NEXT_PUBLIC_ENS_BASE_REGISTRAR_IMPLEMENTATION_OPTIMISM_SEPOLIA ||
      '',
  ...
  421614: {
    ...
    BASE_REGISTRAR:
      process.env.NEXT_PUBLIC_ENS_BASE_REGISTRAR_IMPLEMENTATION_ARBITRUM_SEPOLIA ||
      '',
  ...
  534351: {
    ...
    BASE_REGISTRAR:
      process.env.NEXT_PUBLIC_ENS_BASE_REGISTRAR_IMPLEMENTATION_SCROLL_SEPOLIA ||
      '',
