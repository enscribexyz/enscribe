...
export default function ExploreAddressPage() {
    ...
    useEffect(() => {
        ...
        setIsLoading(true);
        console.log('Starting address validation for:', address, 'on chain:', chainId);
        ...
        const validateAddress = async () => {
            try {
                ...
                try {
                    ...
                    console.log('Bytecode check result:', 
                      isContractAddress ? 'Is contract' : 'Is EOA', 
                      bytecode ? (bytecode === '0x' ? '(empty bytecode)' : '(has bytecode)') : '(no bytecode)');
