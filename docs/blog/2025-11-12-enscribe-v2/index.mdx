...
authors: [nischal]
tags: [enscribe, mainnet, batch-naming, ensip-19]
keywords: [ENS names, Enscribe V2, batch naming, smart contracts, multi-chain, ENSIP-19, contract identity, ethereum mainnet]
image: enscribe-v2-hero.png
---
