...
- **Percentage of Contracts Named** shows how many contracts have been named out of the total number of contracts deployed on Ethereum

![percentage_contracts_named](percentage_contracts_named.png)

- **Proportion of All Contracts Named** shows, as a pie chart, the total counts of Ethereum contracts versus how many have been named

![proportion_contracts_named](proportion_contracts_named.png)

- **Monthly Contract Naming Activity** shows contract naming activity since the beginning of ENS protocol deployment 
