...
We've submitted an ENSIP that extends [ENSIP-5 (Text Records)](https://docs.ens.domains/ensip/5) with standardized metadata fields for smart contracts. This creates one source of truth for contract information, stored directly in ENS records.
