...
The proposal introduces a new resolver profile for complete compiler-generated metadata. Building on ENSIP-4's multi-encoding approach, it supports:
...
*Enscribe's contract-focused interface - Technical details, compiled metadata, and security audits*

![Expanded view showing ABI and source verification](mock-expanded.png)
*Expanded metadata view - Contract ABI, source files, and local verification tools*
...
Join the discussion and help us build standardized, discoverable contract identity for the onchain world.  You can also share your thoughts, suggestions, and any issues you encounter through our [Discord community](https://discord.gg/8QUMMdS5GY), [Telegram](https://t.me/enscribers), or [Twitter/X](https://x.com/enscribe_).
