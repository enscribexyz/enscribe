...
This update makes it easier for teams and DAOs to manage contract naming through their existing Safe workflows. Here's how to use it.
...
- Setting the reverse record for the contract
- Configuring the ENS name if needed
