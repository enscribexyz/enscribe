...
| **Linea** | Alternative L2 option | Low | Experimental, cost-sensitive |
| **Testnet** | Testing and development | Free | Development, testing |

:::Note
Other L2 networks like Arbitrum, Optimism and Scroll doesn't support contract deployment via Enscribe this is because ENS contracts are not deployed on these networks.
Whereas Linea and Base has support for `.linea.eth` and `.base.eth` ENS domains respectively, so you can use them to name your contract during deployment.
:::
...
{/* - Consider using the [Common Patterns](common-patterns) approach instead */}
...
4. **Sign Transactions**: Enscribe will open a modal with all the steps, sign each transaction in your wallet
...
Enscribe provides a detailed success message showing your contract address, ENS name, and transaction details.
:::

Once you close the success modal, you will be redirected to the explore page for your new contract. You can share this URL with your users to let them interact with your contract.
...
Congratulations! You've successfully deployed and named your smart contract with ENS. Here are your next steps:
...
- [Common Naming Patterns](common-patterns) - Learn effective naming strategies
...
- Join our [Telegram](https://t.me/enscribers) for discussions
- Subscribe to our [blog](/blog) for tutorials and announcements

---

*This guide helps you deploy and name smart contracts with ENS, making them more trustworthy and user-friendly. For questions or support, reach out to our community channels.*
