...
- [Use Cases](/guides/common-patterns): Naming patterns and strategies

---

**Ready to name your contract?** Head to [app.enscribe.xyz/nameContract](https://app.enscribe.xyz/nameContract) and give your smart contract the human-readable identity it deserves.

*Making Ethereum contracts more discoverable, one name at a time.*