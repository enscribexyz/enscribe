...
With L2 ENS naming, `app.enscribe.eth` can work consistently across Ethereum, Base, Arbitrum, and other supported networks.

## What You'll Learn

This comprehensive guide covers:

1. **Understanding L2 ENS naming**
2. **Supported Layer 2 networks**
...
![Name Contract L2](/img/guides/l2-contract-name.png)

1. Go to [enscribe.xyz](https://app.enscribe.xyz)
...
![Contract Address L2](/img/guides/contract-address-l2.png)
...
![Contract Name L2](/img/guides/contract-name-l2.png)
...
![ENS Parent Domain L2](/img/guides/ens-parent-l2.png)
...
![Choose L2 Chains L2](/img/guides/choose-l2-modal.png)
...
![Skip L1 Naming](/img/guides/skip-l1.png)
...
![L2 Naming steps](/img/guides/setl2-steps.png)
...
![L2 Contract Naming Success](/img/guides/l2-name-success.png)
...
**Ready to name your L2 contracts?** Head to [Enscribe](https://app.enscribe.xyz), connect to Ethereum mainnet, and give your multi-chain contracts the unified identity they deserve.
