...
|-------------|-------------|------------------|---------------|
| User-facing (L1) | Bridge/Portal contracts<br/>Gateway contracts<br/>Messenger<br/>User-facing proxy contracts | `bridge.l1.<yourl2>.eth`<br/>`portal.l1.<yourl2>.eth`<br/>`messenger.l1.<yourl2>.eth`<br/>`gateway.l1.<yourl2>.eth` | **[Enscribe](https://app.enscribe.xyz/nameContract)** / Raw Tx builder |
| User-facing (L2) | L2 bridge contracts<br/>L2 Gateway contracts<br/>L2 messengers | `bridge.l2.<yourl2>.eth`<br/>`messenger.l2.<yourl2>.eth`<br/>`gateway.l2.<yourl2>.eth` | **[Enscribe](https://app.enscribe.xyz/nameContract)** / Raw Tx builder |
| Protocol/Util (L1) | Rollup contract<br/>Fraud/validity prover<br/>Sequencer/Proposer | `<contract-name>.l1.<yourl2>.eth` | **[Enscribe](https://app.enscribe.xyz/nameContract)** / Raw Tx builder |
| Protocol/Util (L2) | L2 system contracts<br/>Cross-domain messenger<br/>Oracles<br/>Predeploys | `<contract-name>.l2.<yourl2>.eth` | **[Enscribe](https://app.enscribe.xyz/nameContract)** / Raw Tx builder |
| Token | Native token | `<token-symbol>.<yourl2>.eth`<br/>or<br/>`token.<yourl2>.eth` | **[Enscribe](https://app.enscribe.xyz/nameContract)** / Raw Tx builder |
| Other wallets/operations | Multisig wallets<br/>Admins<br/>Security Council<br/>Guardian | `wallet.<yourl2>.eth`<br/>Or<br/>`<role>.<yourl2>.eth` | **[ENS App](https://app.ens.domains/)** |
...
**All Base L1 contracts** can be found [here](https://docs.base.org/base-chain/network-information/base-contracts#l1-contract-addresses) and **L2 contracts** [here](https://docs.base.org/base-chain/network-information/base-contracts#l2-contract-addresses). We will be categorizing key contracts according to our best practice standards.
