...
**Note:** There might be some Ecosystem projects with DAOs or governance contracts, please refer to [DAO best practices](/guides/best-practices/dao) for those contract naming
