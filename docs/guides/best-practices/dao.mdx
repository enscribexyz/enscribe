...
|---------------|-------------|------------------|---------------|
| Governor (core) | Based on Openzepplin Governance framework or Aargon's DAO framework | `governor.<yourdao>.eth` | **[Enscribe](https://app.enscribe.xyz/nameContract)** / Raw Tx builder |
| Governance Token | Token for voting purpose | `<token-symbol>.<youdao>.eth` or `token.<yourdao>.eth` | **[Enscribe](https://app.enscribe.xyz/nameContract)** / Raw Tx builder |
| Timelock controller | Contract that may hold assets and enforce a delay before executing | `timelock.<yourdao>.eth`, `executor.<yourdao>.eth` | **[Enscribe](https://app.enscribe.xyz/nameContract)** / Raw Tx builder |
| Main Wallet | DAO treasury / operations multisig | `wallet.<yourdao>.eth`, `operations.<yourdao>.eth` | **[ENS App](https://app.ens.domains/)** |
| Treasury | DAO treasury where funds are stored | `treasury.<yourdao>.eth` | **[Enscribe](https://app.enscribe.xyz/nameContract)** / Raw Tx builder |
| Voting Contract | Based on Aargon's voting plugins or OZ's Voting Modules | `voting.<yourdao>.eth` | **[Enscribe](https://app.enscribe.xyz/nameContract)** / Raw Tx builder |
| Other wallets (smart wallets/EOAs) | Guardians, Endowment, Admin, Emergency, Veto, Security council | `<role>.<yourdao>.eth` | **[ENS App](https://app.ens.domains/)** |
| Other access/permission/controller/misc Contracts | Delegation contract, Access/permission manager, Controllers, Other Aragon or OZ based contracts | `<contract-name>.<yourdao>.eth` | **[Enscribe](https://app.enscribe.xyz/nameContract)** / **[ENS App](https://app.ens.domains/)**  / Raw Tx builder |
