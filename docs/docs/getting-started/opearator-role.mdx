...
You can execute these transactions using Etherscan’s “Write Contract” feature, Remix, or any other contract interaction tool. To find the correct ENS contract addresses for the network you’re on, refer to the official ENS deployment documentation. The Enscribe contract address for your chain can be found in the Supported Networks section.
