...
> Reverse safety: You typically need to control the contract (Ownable), the proxy admin (Transparent proxy), or the implementation (UUPS). Use `isOwnable`, `isReverseClaimable`, or your own checks before calling.
