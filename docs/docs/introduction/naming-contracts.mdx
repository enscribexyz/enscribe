...
If you want more flexibility, you can use the ReverseClaimer module. This module automatically transfers ownership of the contract’s reverse node to a specified address — usually the deployer — at the time of deployment. Once that’s done, you (as the owner) can set or update the primary name anytime by calling setName(node, newName) on the resolver.  
