...
The [ENS Registry](https://docs.ens.domains/registry/ens) is a smart contract (`ENSRegistry.sol`) that serves as the single source of truth for all ENS domain ownership and control.  
...
- **Explorers**: Etherscan, [Chainlens](https://www.chainlens.com/), Blockscout  
